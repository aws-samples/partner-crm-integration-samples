...
function CreatePrivateOffer() {
        ...
        },
        {
          ...
          "DetailsDocument": {
            "Terms": [
              {
                "Type": "ValidityTerm",
                "AgreementDuration": formData.contractDuration
              }
            ]
          }
        },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess('Private offer created successfully!');
  ...
  return (
    <Container
      header={
        <Header
          variant="h1"
          description="Create a private offer using AWS Marketplace Catalog API"
        >
      ...
      <SpaceBetween direction="vertical" size="l">
        ...
        >
          <SpaceBetween direction="vertical" size="s">
            ...
            <Box>
              <strong>Contract Duration:</strong> User-defined (used in ValidityTerms and PricingTerms)
            </Box>
          </SpaceBetween>
        </Container>
          ...
          actions={
            <SpaceBetween direction="horizontal" size="xs">
              ...
              <Button 
                ...
                loading={loading}
                disabled={!formData.productId || !formData.buyerId || !formData.availabilityEndDate}
              >
                Create Offer
              </Button>
            </SpaceBetween>
        ...
        >
          <SpaceBetween direction="vertical" size="l">
            ...
            <FormField
              ...
              description="Date when the offer becomes unavailable (defaults to 7 days from today)"
            >
              <Input
...
export default CreatePrivateOffer;