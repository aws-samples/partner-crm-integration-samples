...
import { createCPPOPayload } from '../../../shared/utils/payloadTemplates';
...
const CreateCPPO = () => {
  ...
  return (
    <ApiTestInterface
      title="Create CPPO (Channel Partner Private Offer)"
      endpoint="https://catalog.marketplace.us-east-1.amazonaws.com/"
      apiAction="StartChangeSet"
      defaultPayload={createCPPOPayload()}
      onRun={handleRun}
      storageKeyPrefix="offerAutomation_createCPPO"
      isLoading={isLoading}
      error={error}
      success={success}
    />
