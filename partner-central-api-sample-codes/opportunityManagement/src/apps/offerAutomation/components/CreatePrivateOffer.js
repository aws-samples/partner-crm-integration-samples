...
import { createPrivateOfferPayload } from '../../../shared/utils/payloadTemplates';
...
const CreatePrivateOffer = () => {
  ...
  return (
    <ApiTestInterface
      title="Create Private Offer"
      endpoint="https://catalog.marketplace.us-east-1.amazonaws.com/"
      apiAction="StartChangeSet"
      defaultPayload={createPrivateOfferPayload()}
      onRun={handleRun}
      storageKeyPrefix="offerAutomation_createPrivateOffer"
      isLoading={isLoading}
      error={error}
      success={success}
    />
