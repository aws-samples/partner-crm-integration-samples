...
function SimulateApproval() {
  ...
  const fetchOpportunity = async () => {
    try {
      ...
      if (!opportunityId) {
        setError('No opportunity ID provided. Please provide an opportunity ID to simulate review.');
        setLoading(false);
        return;
      }
        ...
        <SpaceBetween size="l">
          ...
          {error.includes('No opportunity ID provided') && (
            <Container>
              ...
              <Form>
                <FormField label="Opportunity ID" description="Enter the opportunity ID you want to simulate review for">
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        if (inputOpportunityId.trim()) {
                          navigate(`/offerautomation/simulate-approval/${inputOpportunityId.trim()}`);
                        }
                      }}
                    >
                      Load Opportunity
      ...
      <SpaceBetween size="l">
        ...
        <Container>
          ...
          <pre style={{ 
            ...
            {decodeServerEntities(JSON.stringify(updatePayload, null, 2))}
          </pre>
        </Container>
...
export default SimulateApproval;