...
/*
 * Purpose
 * PC-API-03 Partner Originated opportunity action required update
 */

public class UpdatePartnerOriginatedActionRequiredOpportunity {
	...
	public static UpdateOpportunityResponse updateOpportunity(String inputFile) {
		...
		if (response != null 
				...
				&& response.lifeCycle().reviewStatus() == ReviewStatus.ACTION_REQUIRED) {
