...
public class BulkCreateOpportunity {
	...
	public static void main(String[] args) {
		...
		String jsonPayloadFilePath = "bulkCreateJson";
		
		List<String> allFiles = getAllFilenamesFromDir(jsonPayloadFilePath);
		
		for (String inputFile : allFiles) {
				System.out.println("Processing " + jsonPayloadFilePath + "/" + inputFile);
				CreateOpportunityResponse response = createOpportunity(jsonPayloadFilePath + "/" + inputFile);
				try {
	...
	public static List<String> getAllFilenamesFromDir (String dirPath) {
		...
		try {
			Path resourceDirectory = Paths
					.get(BulkCreateOpportunity.class.getClassLoader().getResource(dirPath).toURI());
	...
	static CreateOpportunityResponse createOpportunity(String inputFile) {
		...
		System.out.println("Creating opportuninity...");
