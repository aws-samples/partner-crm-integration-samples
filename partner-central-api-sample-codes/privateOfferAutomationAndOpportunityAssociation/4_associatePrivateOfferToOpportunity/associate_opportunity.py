...
"""
Purpose
PC-API -13 Associating a private offer to opportunity
"""
import logging
import boto3
import sys
...
def get_parameters_from_args_and_env():
    ...
    entity_type is always "AwsMarketplaceOffers"
    ...
    """
    # Default values
    default_entity_type = "AwsMarketplaceOffers"  # Always use AWSMarketplaceOffers
    default_entity_identifier = "arn:aws:aws-marketplace:us-east-1:111111111111:AWSMarketplace/Offer/offer-1111111111111"
    ...
    if num_args >= 2:
        ...
        entity_identifier = shared_env.get('OFFER_ARN', default_entity_identifier)
        opportunity_identifier = shared_env.get('OPPORTUNITY_ID', default_opportunity_identifier)
...
def usage_demo():
    ...
    print("-" * 88)
    print("Associate Private Offer to Opportunity.")
    print("-" * 88)
    print("Usage: python associate_opportunity.py [entity_identifier] [opportunity_identifier]")
    print("  entity_type is always 'AWSMarketplaceOffers'")
    ...
    print(f"  Entity Identifier (Offer ARN): {entity_identifier}")
